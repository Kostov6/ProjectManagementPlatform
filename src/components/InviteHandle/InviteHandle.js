...
export default function InviteHandle() {
    ...
    async function accept(){
        ...
        POST(`http://localhost:3001/api/invites/accept/${owner}/${project}`,{})
    }

    function decline(){
        console.log("declining")
        POST(`http://localhost:3001/api/invites/decline/${owner}/${project}`,{})
    }
    ...
    return (
        ...
        <div className="Task-card card">
            <div className="card-content waves-effect waves-block waves-light">
                <h4 className="">{`Accept invite from ${owner} for project ${project}?`}</h4>
                <div className="row">
